...
ActiveRecord::Schema.define(version: 20_191_004_172_104) do
  ...
  create_table 'coupon_instances', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[promotion_id coupon_code], name: 'index_coupon_instances_on_promotion_id_and_coupon_code', unique: true
